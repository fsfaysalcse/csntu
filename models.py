...
class Module(db.Model):
    ...
    lecturer_assignments = db.relationship('LecturerModuleAssignment', backref='module', lazy='dynamic')
...
class LecturerModuleAssignment(db.Model):
    ...
    module = db.relationship('Module', backref=db.backref('lecturer_assignments', lazy=True))
